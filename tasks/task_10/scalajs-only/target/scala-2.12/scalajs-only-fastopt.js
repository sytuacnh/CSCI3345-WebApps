...
class $c_Lexample_Hello$ extends $c_O {
  main__AT__V(args) {
    ...
    this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello, Dr. Lewis!\n");
    this.drawToCanvas__Lorg_scalajs_dom_raw_HTMLCanvasElement__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("mainCanvas"))
  };
  drawToCanvas__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(canvas) {
